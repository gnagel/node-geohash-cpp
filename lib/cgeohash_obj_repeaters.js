...
var cgeohash_fn_repeat_js = {
	...
	decode: function(num_times, hash_string) {
		return seconds_per_call_x_many_times(num_times, function() {
			return cgeohash_obj.dncode(hash_string);
		});
	};
...
var cgeohash_fn_repeat_cpp = {
    encode:        cgeohash_obj_repeater.encode_obj_repeat,
    decode:        cgeohash_obj_repeater.decode_obj_repeat,
    decode_bbox:   cgeohash_obj_repeater.decode_bbox_obj_repeat,
    neighbor:      cgeohash_obj_repeater.neighbor_obj_repeat,
};
