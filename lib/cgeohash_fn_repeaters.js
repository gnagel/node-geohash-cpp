...
var cgeohash_fn_repeat_js = {
	...
	decode: function(num_times, hash_string) {
		return seconds_per_call_x_many_times(num_times, function() {
			return cgeohash_fn.dncode(hash_string);
		});
	};
...
var cgeohash_fn_repeat_cpp = {
    encode:        cgeohash.encode_fn_repeat,
    decode:        cgeohash.decode_fn_repeat,
    decode_bbox:   cgeohash.decode_bbox_fn_repeat,
    neighbor:      cgeohash.neighbor_fn_repeat,
};
